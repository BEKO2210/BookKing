...
import { getWeekDates, useCalendarStore } from "@/store/calendar-store";
...
export function WeekView() {
	...
	const startStr = weekDates[0] ? format(weekDates[0], "yyyy-MM-dd") : "";
	const endStr = weekDates[6] ? format(weekDates[6], "yyyy-MM-dd") : "";
