...
export function BlockerForm({ onClose }: BlockerFormProps) {
	...
	const handleSubmit = (e: React.FormEvent) => {
		...
		const end = isAllDay ? `${endDate}T23:59:59` : `${endDate}T${endTime}:00`;
