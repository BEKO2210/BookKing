			...
			<div className="flex items-center justify-between mb-6 gap-3">
				<div className="flex items-center gap-2">
					...
					<InfoButton title="Services verwalten">
						<p>
							Hier verwalten Sie alle Dienstleistungen, die Kunden buchen
							können:
						</p>
						<ul className="list-disc list-inside space-y-1 ml-1">
							<li>
								<strong>Name & Preis</strong> — Was kostet der Service?
							</li>
							<li>
								<strong>Dauer</strong> — Wie lange dauert der Termin?
							</li>
							<li>
								<strong>Pufferzeit</strong> — Zeit für Vor-/Nachbereitung
							</li>
							<li>
								<strong>Kapazität</strong> — Für Gruppen: wie viele Plätze?
							</li>
							<li>
								<strong>Kategorie</strong> — Sortierung auf der Buchungsseite
							</li>
						</ul>
						<p>
							Inaktive Services werden auf der Buchungsseite nicht angezeigt.
						</p>
					</InfoButton>
				</div>
				<button
