			...
			<div className="flex items-center justify-between mb-6 gap-3">
				<div className="flex items-center gap-2">
					...
					<InfoButton title="Kundenverwaltung">
						<p>
							Hier sehen Sie alle Kunden, die jemals einen Termin gebucht haben:
						</p>
						<ul className="list-disc list-inside space-y-1 ml-1">
							<li>
								Klicken Sie auf einen Kunden für Details und Buchungshistorie
							</li>
							<li>
								<strong>Tags</strong> wie „VIP" oder „Stammkunde" helfen beim
								Sortieren
							</li>
							<li>
								<strong>CSV Export</strong> lädt alle Kundendaten herunter
							</li>
							<li>
								Nutzen Sie die <strong>Suche</strong> für Name, E-Mail oder
								Telefon
							</li>
						</ul>
					</InfoButton>
