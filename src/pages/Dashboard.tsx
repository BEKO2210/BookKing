        ...
        <div className="flex items-center gap-2">
          <InfoButton title="Dashboard-Übersicht">
            ...
            <ul className="list-disc list-inside space-y-1 ml-1">
              <li><strong>Heute</strong> — Anzahl der heutigen Termine</li>
              <li><strong>Monatsumsatz</strong> — Ihr Umsatz diesen Monat</li>
              <li><strong>Auslastung</strong> — Wie voll Ihr Kalender ist</li>
              <li><strong>No-Show Rate</strong> — Anteil verpasster Termine</li>
            </ul>
