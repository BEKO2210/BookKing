    ...
    <div className="min-h-screen bg-gradient-to-b from-primary-50/50 to-white">
      ...
      <footer className="max-w-lg mx-auto px-4 py-6 text-center border-t border-gray-100">
        <div className="flex items-center justify-center gap-4 text-xs text-gray-400">
          <button onClick={() => navigate('/info/how-it-works')} className="hover:text-primary-600 transition-colors">
            So funktioniert's
          </button>
          <span>&middot;</span>
          <button onClick={() => navigate('/info/privacy')} className="hover:text-primary-600 transition-colors">
            Datenschutz
          </button>
          <span>&middot;</span>
          <button onClick={() => navigate('/info/help')} className="hover:text-primary-600 transition-colors">
            Hilfe
          </button>
        </div>
