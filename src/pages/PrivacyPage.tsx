    ...
    <div className="min-h-screen bg-gradient-to-b from-primary-50/50 to-white">
      ...
      <main id="main-content" className="max-w-2xl mx-auto px-4 py-8 space-y-8">
        ...
        <section>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Einfach und verständlich erklärt</p>
            </div>
          </div>
        ...
        <section className="card p-5">
          <h3 className="font-semibold text-gray-900 mb-3">Cookies & Tracking</h3>
          <p className="text-sm text-gray-600 leading-relaxed">
            BookKing verwendet <strong>keine Tracking-Cookies</strong> und
            kein Google Analytics. Wir speichern nur technisch notwendige Daten
            (wie Ihre Einstellungen) lokal auf Ihrem Gerät. Es werden keine
        ...
        <section className="card p-5 bg-gray-50 border-0">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="font-semibold text-gray-900">Fragen zum Datenschutz?</h3>
          </div>
          <p className="text-sm text-gray-600 leading-relaxed">
            ...
            uns an <span className="font-medium text-primary-600">datenschutz@bookking.app</span>.
          </p>
        </section>
