	...
	if (isLoading || !stats) {
		return (
			<div className="space-y-4">
				{["a", "b", "c", "d"].map((id) => (
					<div key={id} className="card h-48 animate-pulse bg-gray-50" />
				))}
			</div>
		);
	}
			...
			<div className="flex items-center gap-2 mb-6">
				<div>
					...
					<p className="text-gray-500 text-sm">
						Detaillierte Auswertungen Ihrer Buchungen.
					</p>
				</div>
				<InfoButton title="Statistiken">
					...
					<ul className="list-disc list-inside space-y-1 ml-1">
						<li>
							<strong>Umsatz-Chart</strong> — Tägliche Umsatzentwicklung der
							letzten 30 Tage
						</li>
						<li>
							<strong>Auslastung</strong> — Wie viel Prozent Ihrer verfügbaren
							Zeit gebucht ist
						</li>
						<li>
							<strong>Stoßzeiten</strong> — Wann buchen die meisten Kunden?
						</li>
						<li>
							<strong>No-Show Rate</strong> — Anteil der nicht wahrgenommenen
							Termine
						</li>
					</ul>
				</InfoButton>
