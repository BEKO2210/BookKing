			...
			>
				...
				<section>
					...
					<p className="text-gray-600 leading-relaxed">
						Mit BookKing buchen Sie Termine in nur 4 einfachen Schritten. Kein
						Konto nötig, kein Anruf, keine Wartezeiten. Einfach online den
						passenden Termin finden und bestätigen.
					</p>
				</section>
						...
						{[
							{
								icon: Bell,
								title: "Erinnerungen",
								desc: "Sie erhalten automatische Erinnerungen vor Ihrem Termin per E-Mail.",
							},
							{
								icon: Smartphone,
								title: "Handy-App",
								desc: "Installieren Sie BookKing auf Ihrem Handy — es funktioniert wie eine echte App.",
							},
							{
								icon: Shield,
								title: "Datenschutz",
								desc: "Ihre Daten sind sicher. Wir verwenden sie nur für die Terminverwaltung.",
							},
							{
								icon: CreditCard,
								title: "Flexible Zahlung",
								desc: "Zahlen Sie vor Ort oder nutzen Sie die optionale Online-Anzahlung.",
							},
						].map((f) => (
